    ...
    <button
      ...
      className={cn(
        ...
        isDark
          ...
          : "border-slate-200 bg-[color:var(--bg-card)] text-slate-600 shadow"
      )}
    >
      <span className={cn("relative z-10 flex-1 text-center", !isDark ? "text-slate-900" : "text-slate-500")}>Light</span>
      <span className={cn("relative z-10 flex-1 text-center", isDark ? "text-[color:var(--accent-primary-foreground)]" : "text-slate-400")}>Dark</span>
      <span
        className={cn(
